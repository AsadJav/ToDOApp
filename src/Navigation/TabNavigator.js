...
function MyTabs() {
  return (
    <Tab.Navigator screenOptions={{headerShown:false,tabBarActiveTintColor:COLORS.purple}}>
      <Tab.Screen name="Home" component={gestureHandlerRootHOC(HomeNavigator)} options={{
          tabBarLabel: 'Home',
          tabBarIcon: ({ color, size }) => (
            <AppIcon IconName={'home'} IconColor={color} IconSize={size}/>
          ),
        }}/>
      <Tab.Screen name='Achives' component={gestureHandlerRootHOC(ArchivesScreen)} options={{
          tabBarLabel: 'Archives',
          tabBarIcon: ({ color, size }) => (
            <AppIcon IconName={'archive'} IconColor={color} IconSize={size}/>
          ),
        }}/>
      <Tab.Screen name='Completed' component={gestureHandlerRootHOC(CompletedScreen)}  options={{
          tabBarLabel: 'Completed',
          tabBarIcon: ({ color, size }) => (
            <AppIcon IconName={"checkmark-circle-outline"} IconColor={color} IconSize={size}/>
          ),
        }}/>
      <Tab.Screen name="Profile" component={gestureHandlerRootHOC(ProfileScreen)} options={{
          tabBarLabel: 'Profile',
          tabBarIcon: ({ color, size }) => (
